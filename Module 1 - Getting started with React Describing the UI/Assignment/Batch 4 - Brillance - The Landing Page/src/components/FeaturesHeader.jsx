...
export default function FeaturesHeader() {
  return (
    <div className="self-stretch px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-265 lg:w-265 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
      <div className="w-full max-w-154 lg:w-154 px-4 sm:px-6 py-4 sm:py-5 shadow-none overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4">
        {/* Badge */}
        ...
        <div className="w-full max-w-[598.06px] lg:w-[598.06px] text-center flex justify-center flex-col text-[#49423D] text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold leading-tight md:leading-15 tracking-tight">
